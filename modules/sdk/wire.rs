...
//! `modules/sdk/replica_facade.rs` instead of importing these
...
// `.context/rfc_partition_groups.md` §"Wire envelope". The existing 3-byte
// form is unchanged — partitioned and legacy channels coexist via
// distinct ports, never via in-band flag bytes.
//
...
// algorithm as `quantum/modules/sdk/wire.rs::fnv1a_64` so a hash
