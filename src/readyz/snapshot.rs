use crate::activation::{ActivationDigestError, ReadinessDigestBuilder, WarmupReadinessRecord};
...
pub struct ReadyzRecord {
    ...
    pub activation_barrier_id: Option<String>,
    pub shadow_apply_state: crate::activation::ShadowApplyState,
...
struct PendingReadyzRecord {
    ...
    shadow_apply_state: crate::activation::ShadowApplyState,
