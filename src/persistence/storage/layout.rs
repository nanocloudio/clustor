use crate::lifecycle::bootstrap::boot_record::{BootRecord, BootRecordError, BootRecordStore};
use crate::replication::consensus::RaftMetadataStore;
...
mod tests {
    use super::*;
    use crate::lifecycle::bootstrap::boot_record::BootRecord;
