...
use super::super::http::RequestDeadline;
use super::super::tls::{decode_peer_certificate, server_name, TlsIdentity, TlsTrustStore};
use super::super::{CertificateError, HttpError, NetError};
use crate::cp::client::{CpApiTransport, CpClientError, TransportError, TransportResponse};
...
#[cfg(test)]
mod tests {
    use super::super::super::http::read_request;
    use super::*;
