...
impl From<crate::admin::AdminServiceError> for HttpAdminError {
    fn from(err: crate::admin::AdminServiceError) -> Self {
        match err {
            ...
            crate::admin::AdminServiceError::Security(err) => match err {
            ...
            crate::admin::AdminServiceError::Admin(admin_err) => match admin_err {
                ...
                crate::admin::AdminError::CpUnavailable { clause, response } => HttpAdminError {
                    status: 503,
                    body: serde_json::json!({
...
mod tests {
    ...
    use crate::consensus::{ConsensusCore, ConsensusCoreConfig};
